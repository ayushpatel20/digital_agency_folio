/**
 * BrandIcons — inline SVG icons for social/brand logos removed from lucide-react v1.x
 * These icons (Twitter/X, Github, Youtube, Linkedin, Instagram) are no longer
 * exported by lucide-react and must be provided as inline SVGs.
 */

export const XTwitterIcon = ({ size = 16, className = "" }: { size?: number; className?: string }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
